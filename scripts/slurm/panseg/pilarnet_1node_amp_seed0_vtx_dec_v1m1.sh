...
WANDB_NAME="pretrain-sonata-pilarnet-1m-amp-4GPU-2025-10-17_10-45-36-seed0"
CKPT_PATH="${CKPT_BASE_PATH}/${WANDB_NAME}/model/model_last.pth"

# define configs based on array task ID
if [ $SLURM_ARRAY_TASK_ID -eq 1 ]; then
    CONFIG="detector-v1m1-pt-v3m2-ft-vtx-dec-100"
elif [ $SLURM_ARRAY_TASK_ID -eq 2 ]; then
    CONFIG="detector-v1m1-pt-v3m2-ft-vtx-dec-1000"
elif [ $SLURM_ARRAY_TASK_ID -eq 3 ]; then
    CONFIG="detector-v1m1-pt-v3m2-ft-vtx-dec-10000"
elif [ $SLURM_ARRAY_TASK_ID -eq 4 ]; then
    CONFIG="detector-v1m1-pt-v3m2-ft-vtx-dec-100000"
elif [ $SLURM_ARRAY_TASK_ID -eq 5 ]; then
    CONFIG="detector-v1m1-pt-v3m2-ft-vtx-dec-1000000"
fi
