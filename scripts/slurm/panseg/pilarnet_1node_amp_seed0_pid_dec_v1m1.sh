...
if [ $SLURM_ARRAY_TASK_ID -eq 1 ]; then
    CONFIG="detector-v1m1-pt-v3m2-ft-pid-dec-100"
elif [ $SLURM_ARRAY_TASK_ID -eq 2 ]; then
    CONFIG="detector-v1m1-pt-v3m2-ft-pid-dec-1000"
elif [ $SLURM_ARRAY_TASK_ID -eq 3 ]; then
    CONFIG="detector-v1m1-pt-v3m2-ft-pid-dec-10000"
elif [ $SLURM_ARRAY_TASK_ID -eq 4 ]; then
    CONFIG="detector-v1m1-pt-v3m2-ft-pid-dec-100000"
elif [ $SLURM_ARRAY_TASK_ID -eq 5 ]; then
    CONFIG="detector-v1m1-pt-v3m2-ft-pid-dec-1000000"
fi
