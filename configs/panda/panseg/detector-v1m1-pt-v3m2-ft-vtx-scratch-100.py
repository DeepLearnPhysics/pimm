_base_ = [
    "./detector-v1m1-pt-v3m2-ft-vx-fft.py",
]
...
wandb_project = "PanSeg-VTX-Sonata-PILArNet-M"  # Change to your desired project name
wandb_run_name = f"sonata-pilarnet-panseg-vtx-ft-v1-4GPU-{num_events_train}ev-256patch-scratch-learned-STUFF_HEAD-20e"  # Descriptive name for this run
