...
wandb_run_name = f"sonata-pilarnet-panseg-pid-ft-v1-4GPU-{num_events_train}ev-256patch-fft-learned-STUFF_HEAD-20e-momentum-classcond"  # Descriptive name for this run
