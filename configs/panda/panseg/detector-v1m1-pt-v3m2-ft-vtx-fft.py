...
wandb_run_name = f"sonata-pilarnet-insseg-vtx-ft-v1-4GPU-{num_events_train}ev-256patch-fft-learned-STUFF_HEAD"  # Descriptive name for this run
...
hooks = [
    ...
    dict(
        ...
        stuff_classes=[0],
        iou_thresh=0.5,
        pid_class_names=["thing",],  # exclude led class
