_base_ = [
    "./detector-v1m1-pt-v3m2-ft-pid-dec.py",
]
...
wandb_run_name = f"sonata-pilarnet-panseg-pid-ft-v1-4GPU-{num_events_train}ev-256patch-dec-learned-STUFF_HEAD-20e"  # Descriptive name for this run
