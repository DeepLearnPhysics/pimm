_base_ = [
    "./detector-v1m1-pt-v3m2-ft-vtx-dec.py",
]
...
wandb_run_name = f"sonata-pilarnet-insseg-vtx-ft-v1-4GPU-{num_events_train}ev-256patch-lin-learned-STUFF_HEAD-20e"  # Descriptive name for this run
...
hooks = [
    ...
    dict(
        ...
        stuff_classes=[0],
        iou_thresh=0.5,
        pid_class_names=["thing",],
        require_class_for_match=False,
    ),
    dict(type="CheckpointSaver", save_freq=None, evaluator_every_n_steps=250),
    dict(
