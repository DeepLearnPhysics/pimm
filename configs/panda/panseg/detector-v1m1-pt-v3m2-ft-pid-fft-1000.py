_base_ = [
    "./detector-v1m1-pt-v3m2-ft-pid-fft.py",
]
...
wandb_run_name = f"sonata-pilarnet-panseg-pid-ft-v1-4GPU-{num_events_train}ev-256patch-fft-learned-STUFF_HEAD-20e"  # Descriptive name for this run
