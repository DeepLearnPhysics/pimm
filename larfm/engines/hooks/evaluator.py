...
from larfm.utils.misc import intersection_and_union_gpu

from .default import HookBase
from .builder import HOOKS
from larfm.models.utils.structure import Point
from larfm.models.utils.misc import offset2bincount
...
class PretrainEvaluator(HookBase):
    ...
    def get_backbone(self):
        ...
        elif hasattr(model, "backbone"): # hmae
...
class InstanceSegmentationEvaluator(HookBase):
    ...
    def __init__(
        ...
        self.class_names = tuple(pid_class_names or [])
