...
from larfm.models.losses import build_criteria
from larfm.models.modules import PointModel
from larfm.models.utils.misc import offset2batch, offset2bincount
...
class Detector(PointModel):
    ...
    def forward(self, input_dict, return_point=False):
        """based on DefaultSegmentorV2 in larfm/models/default.py"""
