...
from larfm.models.utils.serialization import encode
from larfm.models.utils import (
    offset2batch,
    batch2offset,
    offset2bincount,
    bincount2offset,
...
class Point(Dict):
    """
    Point Structure of larfm

    A Point (point cloud) in larfm is a dictionary that contains various properties of
